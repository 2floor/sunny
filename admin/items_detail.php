...
if(isset($_SESSION['items']['category'])){
  $category = $_SESSION['items']['category'];
}

$option = createItemsName($category);

if(isset($_POST['method'])){
  if ($_POST ['method'] == "get_items_name") {
...
function createItemsName($cate){
  global $common_logic;
  $cate_row = $common_logic->select_logic("select * from t_items where category = ?", array($cate));
  $option = '';
  foreach($cate_row as $row){
    $option .= '<option value="'.$row['items_id'].'">'.$row['title'].'</option>';
  }
  return $option;
}
...
<body class="fixed-left">
							...
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									...
									<div class="formRow" style="display:none;">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate" name="title" id="title" value="" autocomplete="none">
											</div>
										</div>
									</div>
										...
										<div class="formTxt">
											<div class="formIn50">
												<select name="category" id="category" class="form-control validate required">
													...
													<option value="ディスプレイ/ガラス">ディスプレイ/ガラス</option>
													<option value="発振器">発振器</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<select name="items_id" id="items_id" class="form-control validate required">
													<?php echo $option; ?>
												</select>
											</div>
										</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate" name="movie_title" id="movie_title" value="" autocomplete="none">
											</div>
										</div>
									</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate" name="movie_url" id="movie_url" value="" autocomplete="none">
											</div>
										</div>
									</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<textarea type="text" class="form-control validate" name="lead" id="lead"></textarea>
											</div>
										</div>
									</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<div class="input-group">
													<input type="text" class="form-control validate date" placeholder="yyyy-mm-dd" name="disp_date" id="disp_date" autocomplete="off">
	...
	<script src="../assets/admin/js/items_detail.js"></script>
	<script src='https://unpkg.com/tinymce@4.9.11/tinymce.js'></script>
	...
	<input type="hidden" id="ct_url" value="../controller/admin/items_detail_ct.php">
	...
	<!--  //ファイル即時アップロード用CT -->
	<input type="hidden" id="img_path1" value="items_detail/">
...
$(function(){
  $('#category').change(function() {
    var cate = $(this).val();
    $.ajax({
     	url:'./items_detail.php',
        type: 'POST',
        cache: false,
        data: {
          method : 'get_items_name',
          category : cate
        },
	dataType: 'json'
	}).done(function(data, status, xhr) {
          $('#items_id').children().remove();
          $('#items_id').append(data.option);
