...
<input type="hidden" id="ct_url" value="../controller/admin/auto_rank_survival_ct.php">
<input type="hidden" id="id" value="">
<input type="hidden" id="page_type" value="">
<input type="hidden" id="common_ct_url" value="../controller/admin/common_ct.php">
<input type="hidden" id="page_title_js" value="Survival自動処理">
<input type="hidden" id="data_type" value="3">
<!-- 現在のページ位置 -->
