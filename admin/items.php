...
<body class="fixed-left">
						...
						<div class="row">
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									...
									<div class="formRow">
										<div class="formItem">
											アプリケーションカテゴリ<br>(半角カンマ区切りで入力お願い致します。)

										</div>
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate" name="etc1" id="etc1" value="" autocomplete="none">
											</div>
										</div>
									</div>
									<div class="formRow">
										<div class="formItem">
											加工対象カテゴリ<br>(半角カンマ区切りで入力お願い致します。)

										</div>
										<div class="formTxt">
											<div class="formIn50">
												<input type="text" class="form-control validate" name="etc2" id="etc2" value="" autocomplete="none">
											</div>
										</div>
									</div>
									<div class="formRow">
	...
	<script src="../assets/admin/js/items.js"></script>
	...
	<input type="hidden" id="ct_url" value="../controller/admin/items_ct.php">
	...
	<!--  //ファイル即時アップロード用CT -->
	<input type="hidden" id="img_path1" value="items/">
