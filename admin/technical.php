							...
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									...
									<div class="formRow" style="">
										<div class="formItem">画像</div>
										<div class="formTxt">
											<div class="formIn50">
												<div class="fileupload btn btn-primary btn-bordred waves-effect w-md waves-light">
													<span> ファイルを選択 </span>
													<input type="file" class="upload" name="img" id="file1" jq_id="1" multiple="multiple">
												</div>
									...
									<div class="formRow">
										<div class="formItem">
											PDFファイル<span class="label01 require_text">必須</span>
										</div>
										<div class="formTxt">
											<div class="formIn50">
												<div class="fileupload btn btn-primary btn-bordred waves-effect w-md waves-light">
...
<!-- Start Personal script -->
	<script src="../assets/admin/js/technical.js"></script>
	...
	<input type="hidden" id="ct_url" value="../controller/admin/technical_ct.php">
	...
	<!--  //ファイル即時アップロード用CT -->
	<input type="hidden" id="img_path1" value="technical/">
	...
	<input type="hidden" id="img_path2" value="technical/">
	<input type="hidden" id="img_length2" class="hid_img_length" value="1">
	<input type="hidden" id="img_type2" class="hid_img_type" value="PDF,pdf">
	<!-- 現在のページ位置 -->
