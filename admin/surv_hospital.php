                    ...
                    <div class="searchBox">
                        ...
                        <div class="searchBoxRight">
                            <div class="input-group">
                                ...
                                <input type="file" id="upload-file" data-type="survival" name="upload-file" class="form-control upload-file-hidden upload-csv" accept=".csv,.xlsx,.xls">
                            </div>
...
<input type="hidden" id="upload_csv_type" value="survival">
