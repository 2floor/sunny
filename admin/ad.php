						...
						<div class="row">
							<div class="col-xs-12" id="frm">
								<div class="contentBox">
									...
									<div class="formRow" style="">
										<div class="formItem">URL</div>
										<div class="formTxt">
											<div class="formIn50">
												<input type="url" class="form-control validate url" name="detail" id="detail">
											</div>
										</div>
									</div>
									...
									<div class="formRow">
										...
										<div class="formTxt">
											<div class="formIn50">
												<div class="input-group">
													<input type="text" class="form-control validate required" placeholder="yyyy-mm-dd" name="disp_date" id="disp_date">
