...
class hospital_cancer_import implements OnEachRow, WithBatchInserts, WithChunkReading, WithStartRow
{
    ...
    public function getErrors()
    {
        if (!empty($this->errors)) {
            $header = [
                'row' =>  json_encode(["都道府県", "", "ID", "SHデータベース登録新名称", "", "拠点病院（確認用）", "集学的治療体制","学会認定施設情報", "特記事項", "名医", "TOP名医　医師名", "名医 医師名", "先進医療", "先進医療　内容", "特別な治療法 陽子線、重粒子線など", "薬物療法を避けたい", "手術を避けたい", "放射線治療を避けたい", "早く手術を受けたい", "なるべく早く退院したい", "麻酔科の腕が良い", "女医が担当してくれる", "患者受け入れ条件あり", "エラー"], JSON_UNESCAPED_UNICODE),
                'error' => '',
            ];
