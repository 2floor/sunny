...
class stage_logic extends base_logic
{
        ...
        for ($i = 0; $i < count($list ?? []); $i++) {
            ...
            $return_html .= "
					<tr " . $back_color_html . ">
						...
						<td>" . $row['cancer']['cancer_type_stage'] . "</td>
						<td>" . $row['total_num_new'] . "</td>
						<td>" . $created_at . "</td>
						<td>" . $updated_at . "</td>
						<td>
							$edit_html_a
    ...
    {
        return Cancer::select(['id', 'cancer_type', 'cancer_type_stage'])->orderBy('order_num')->get();
    }
