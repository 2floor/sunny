...
tinymce.init({
  ...
  images_upload_base_path: '../upload_files/items_detail',
  language: 'ja' ,
 ...
 */
function fd_add(fd){
    if (tinyMCE.activeEditor != undefined) fd.append("lead", tinyMCE.activeEditor.getContent());
    if (tinyMCE.activeEditor != undefined) fd.append("detail", tinyMCE.activeEditor.getContent());

    if (tinyMCE.activeEditor != undefined) fd.append("lead", tinymce.get('lead').getContent());
    if (tinyMCE.activeEditor != undefined) fd.append("detail", tinymce.get('detail').getContent());
