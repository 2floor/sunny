...
class stage_ct
{
    ...
    private function entry_new_data($post)
    {
        ...
        $stageData = [
            ...
            'year' => $post['year'],
            'total_num_new' => is_numeric($post['total_num_new']) ? $post['total_num_new'] : null,
            'stage_new1' => is_numeric($post['stage_new1']) ? $post['stage_new1'] : null,
            'stage_new2' => is_numeric($post['stage_new2']) ? $post['stage_new2'] : null,
            'stage_new3' => is_numeric($post['stage_new3']) ? $post['stage_new3'] : null,
            'stage_new4' => is_numeric($post['stage_new4']) ? $post['stage_new4'] : null,
            'total_num_rank' => is_numeric($post['total_num_rank']) ? $post['total_num_rank'] : null,
            'local_num_rank' => is_numeric($post['local_num_rank']) ? $post['local_num_rank'] : null,
            'pref_num_rank' => is_numeric($post['pref_num_rank']) ? $post['pref_num_rank'] : null,
            'total_num_rank_stage1' => is_numeric($post['total_num_rank_stage1']) ? $post['total_num_rank_stage1'] : null,
            'total_num_rank_stage2' => is_numeric($post['total_num_rank_stage2']) ? $post['total_num_rank_stage2'] : null,
            'total_num_rank_stage3' => is_numeric($post['total_num_rank_stage3']) ? $post['total_num_rank_stage3'] : null,
            'total_num_rank_stage4' => is_numeric($post['total_num_rank_stage4']) ? $post['total_num_rank_stage4'] : null,
            'local_num_rank_stage1' => is_numeric($post['local_num_rank_stage1']) ? $post['local_num_rank_stage1'] : null,
            'local_num_rank_stage2' => is_numeric($post['local_num_rank_stage2']) ? $post['local_num_rank_stage2'] : null,
            'local_num_rank_stage3' => is_numeric($post['local_num_rank_stage3']) ? $post['local_num_rank_stage3'] : null,
            'local_num_rank_stage4' => is_numeric($post['local_num_rank_stage4']) ? $post['local_num_rank_stage4'] : null,
            'pref_num_rank_stage1' => is_numeric($post['pref_num_rank_stage1']) ? $post['pref_num_rank_stage1'] : null,
            'pref_num_rank_stage2' => is_numeric($post['pref_num_rank_stage2']) ? $post['pref_num_rank_stage2'] : null,
            'pref_num_rank_stage3' => is_numeric($post['pref_num_rank_stage3']) ? $post['pref_num_rank_stage3'] : null,
            'pref_num_rank_stage4' => is_numeric($post['pref_num_rank_stage4']) ? $post['pref_num_rank_stage4'] : null,
        ];
